...
let li1_script = ["玫瑰","花束"];
let script2_li = ["name","sales","origin"];   
let li2_script = ["KIRBY","特價NT$<span>2699</span>元","原價NT$<span><s>3000</s></span>元"];
let img_array = ['img/redrose/rr1.jpg','img/redrose/rr2.jpg','img/redrose/rr3.jpg','img/redrose/rr4.jpg','img/redrose/rr5.jpg','img/redrose/rr6.jpg'];
...
Name(6);
function Name(n){
    let Name = ["紅玫瑰","紅玫瑰","紅玫瑰","紅玫瑰","紅玫瑰","紅玫瑰"];
    for(let i =0;i<n;i++){
